...
namespace MvvmAspire.Controls
{
    public class ListViewRenderer : Xamarin.Forms.Platform.iOS.ListViewRenderer
    {
        ...
        protected MvvmAspire.Controls.ListView BaseControl { get { return ((MvvmAspire.Controls.ListView)this.Element); } }
        ...
        private void SetItemsSource()
        {
            ...
            Control.ScrollEnabled = ((ICollection)Element.ItemsSource).Count != 1;
