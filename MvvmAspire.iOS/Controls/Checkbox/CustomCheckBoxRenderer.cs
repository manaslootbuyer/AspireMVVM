...
{
	public class CustomCheckBoxRenderer : ViewRenderer<CustomCheckBox, CustomCheckboxView>
	{
		UILabel linkLabel;
		...
		protected override void OnElementChanged(ElementChangedEventArgs<CustomCheckBox> e)
		{
			...
			if (Control == null)
			{
                ...
                var checkBox = new CustomCheckboxView(Bounds, checkedImageSource, uncheckedImageSource, Element);//, Element.WidthRequest, Element.HeightRequest, Element.Spacing);
		...
		private void UpdateFont()
		{
			if (!string.IsNullOrEmpty (Element.FontName)) {
				...
				//if (font != null)
				//{
				//	var fontName = font.GetFontName(FontStyle.Regular);
