...
namespace MvvmAspire.Controls
{
	...
	public class CustomCheckboxView : UIButton
	{
		...
		public CustomCheckboxView(CGRect bounds, string checkedImage, string uncheckImage, CustomCheckBox checkBox/**, double widthRequest, double heightRequest, double? spacing**/)
			: base(bounds)
		{
        ...
        void SetCheckBoxImage(UIImage image, UIControlState state)
        {
            ...
            image.Draw(new CGRect(0, 0, this.checkBox.ImageHeight, this.checkBox.ImageHeight));
