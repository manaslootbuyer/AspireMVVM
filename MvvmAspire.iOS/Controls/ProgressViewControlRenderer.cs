...
namespace MvvmAspire.Controls
{
    public class ProgressViewControlRenderer : Xamarin.Forms.Platform.iOS.LabelRenderer
    {
        ...
        protected MvvmAspire.Controls.ProgressView BaseElement
        {
            get { return Element as MvvmAspire.Controls.ProgressView; }
        }
        ...
        protected override void OnElementChanged(ElementChangedEventArgs<Xamarin.Forms.Label> e)
        {
            ...
            if (BaseElement != null)
            {
                ...
                {
                    var element = (MvvmAspire.Controls.ProgressView)s;
