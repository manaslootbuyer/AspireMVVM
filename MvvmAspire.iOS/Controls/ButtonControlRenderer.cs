...
[assembly: ExportRenderer(typeof(MvvmAspire.Controls.Button), typeof(ButtonControlRenderer))]
namespace MvvmAspire.Controls
{
    public class ButtonControlRenderer : ButtonRenderer
    {
        protected override void OnElementChanged(ElementChangedEventArgs<Xamarin.Forms.Button> e)
        {
            ...
            var baseElement = Element as MvvmAspire.Controls.Button;
            if (baseElement != null)
            {
        ...
        void SetBackgroundImagePattern(MvvmAspire.Controls.Button element)
        {
            if (element.BackgroundImagePattern != null && !string.IsNullOrEmpty(element.BackgroundImagePattern.File))
            {
