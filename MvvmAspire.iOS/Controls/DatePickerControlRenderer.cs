    ...
    public class DatePickerControlRenderer : ViewRenderer<DatePicker, UITextField>
    {
        ...
        protected override void OnElementChanged(ElementChangedEventArgs<DatePicker> e)
        {
            ...
            if (e.NewElement != null)
            {
				...
				//var font = Resolver.Get<IFontService>();
				//if (font != null)
				//{
    //        	    Control.Font = UIFont.FromName(font.GetFontName(Element.FontStyle), (nfloat)Element.FontSize);
				//}
        ...
        protected override void OnElementPropertyChanged(object sender, PropertyChangedEventArgs e)
        {
			...
			//	if (font != null)
			//	{
   //      	       base.Control.Font = UIFont.FromName(font.GetFontName(Element.FontStyle), (nfloat)Element.FontSize);
			//	}
    ...
    //		var baseElement = e.NewElement as MvvmAspire.Controls.DatePicker;
    ...
    //				var element = (MvvmAspire.Controls.DatePicker)s;
    ...
    //	{
    //		var baseElement = Element as MvvmAspire.Controls.DatePicker;;
    ...
    //	protected virtual void SetBackgroundImage(MvvmAspire.Controls.DatePicker element)
    //	{
    //		if (element.BackgroundImage != null && !string.IsNullOrEmpty(element.BackgroundImage.File))
    //		{
    //		//	var image = UIImage.FromBundle(element.BackgroundImage.File);
    ...
    //	protected virtual void SetTextAlignment(MvvmAspire.Controls.DatePicker element)
    //	{
    //		if (Control == null) return;
