...
namespace MvvmAspire.Controls
{
    public class RoundedComboBoxRenderer : ViewRenderer<RoundedComboBox, UITextField>
    {
        ...
        protected override void OnElementChanged(ElementChangedEventArgs<RoundedComboBox> e)
        {
            ...
            { 
                if (UIAccessibility.IsVoiceOverRunning && picker != null)
                {
                    UIAccessibility.PostNotification(UIAccessibilityPostNotification.ScreenChanged, picker);
                }
                return true;
            };
        ...
        void SetAccesibilityLabel(RoundedComboBox element)
        {
            ...
            Control.AccessibilityHint = "Double tap to open";
        }
        ...
        protected override void OnElementPropertyChanged(object sender, PropertyChangedEventArgs e)
        {
            ...
            var element = Element as MvvmAspire.Controls.RoundedComboBox;
        ...
        private void SetImages(double heightConstraint)
        {
            ...
            if (element.ImageRight != null && element.ImageRight.File != null)
            {
                ...
                paddingView.Frame = new CoreGraphics.CGRect(0, 0, element.ImageRightWidth + element.TextPadding.Right, element.ImageRightWidth);
