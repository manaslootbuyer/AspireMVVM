...
namespace MvvmAspire.Services
{
    public class XamarinFormsNavigation : INavigation
    {
        ...
        Type mainViewModel;
        Xamarin.Forms.Page currentPage;
        ...
        protected UnityDependencyResolver Resolver { get { return MvvmAspire.Resolver.Current as UnityDependencyResolver; } }
        ...
        public XamarinFormsNavigation(Func<Application> getApplication)
        {
            ...
            if (!(MvvmAspire.Resolver.Current is UnityDependencyResolver))
        ...
        protected BaseViewModel Resolve(Type viewModelType, object parameters, bool skipInit, params object[] dependencies)
        {
            ...
            if (parameters != null)
            {
                foreach (var item in MvvmAspire.ReflectionHelper.ToFlatDictionary(parameters))
                {
            ...
            try
            {
                ...
                if (page is NavigationPage)
                    ((NavigationPage)page).CurrentPage.BindingContext = viewModel;
                else
            ...
            where TViewModel : BaseViewModel
        {
            ...
            if (!isChangingMainPage && Device.RuntimePlatform == Device.Android)
            {
        ...
        protected Page GetAnimationPage(Page page)
        {
            ...
            //    var tabbedPageCopy = tabbedPage is MvvmAspire.Controls.TabbedPage ? new MvvmAspire.Controls.TabbedPage() : new TabbedPage();
            ...
            //    }
            //    if (tabbedPage is MvvmAspire.Controls.TabbedPage)
            //    {
            //        var baseTabbedPage = (MvvmAspire.Controls.TabbedPage)tabbedPage;
            //        var baseTabbedPageCopy = (MvvmAspire.Controls.TabbedPage)tabbedPageCopy;
        ...
        public async Task<BaseViewModel> PopAsync(bool animated)
        {
            ThrowOnEmptyStack();
            isPopping = true;
            var task = currentPage.Navigation.PopAsync(animated);
            isPopping = false;
            await task;
        ...
        void CleanUpPage(Page page)
        {
            ...
            if (Device.RuntimePlatform == Device.WPF || Device.RuntimePlatform == Device.Android)
                return;
        ...
        public async Task<BaseViewModel> PushAsync(Type viewModelType, object parameters, bool animated)
        {
            ...
            if (!await ClearMainPageAsync(viewModelType))
            {
                ...
                navigationStack.Add(viewModel);
                    if (Device.RuntimePlatform == Device.Android) animated = false;
        ...
        public async Task<BaseViewModel> PushModalAsync(Type viewModelType, object parameters, bool animated)
        {
            ...
            await oldPage.Navigation.PushModalAsync(currentPage, animated);
