...
namespace MvvmAspire.Controls
{
    ...
    public class LabelRendererHelper
        {
            private readonly Xamarin.Forms.Label _label;
            private readonly string _text;
            private readonly StringBuilder _builder;

            public LabelRendererHelper(Xamarin.Forms.Label label, string text)
            {
                _label = label;
                _text = text.Trim();
            ...
            {
                if (_label.HorizontalTextAlignment == Xamarin.Forms.TextAlignment.Start) return;
