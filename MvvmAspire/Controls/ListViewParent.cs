...
namespace  MvvmAspire.Controls
{
    ...
    public class ListViewParent : ContentView
    {
        ...
        public static BindableProperty CustomPlaceholderProperty =
            BindableProperty.Create("CustomPlaceholder", typeof(View), typeof(ListViewParent), null, propertyChanged: CustomPlaceholderChanged);

        public static BindableProperty ListviewProperty =
            BindableProperty.Create("Listview", typeof(ListView), typeof(ListViewParent), null, propertyChanged: ListViewChanged);
