...
namespace  MvvmAspire.Controls
{
    ...
    public class WrapLayout : Layout<View>
    {
        ...
        public static readonly BindableProperty OrientationProperty =
            BindableProperty.Create("Orientation", typeof(StackOrientation), typeof(WrapLayout), StackOrientation.Vertical,
        ...
        public static readonly BindableProperty SpacingProperty =
            BindableProperty.Create("Spacing", typeof(double), typeof(WrapLayout), 6,
                propertyChanged: (bindable, oldvalue, newvalue) => ((WrapLayout)bindable).OnSizeChanged());
        ...
        private SizeRequest DoVerticalMeasure(double widthConstraint, double heightConstraint)
        {
            ...
            foreach (var size in Children.Select(item => item.Measure(widthConstraint, heightConstraint)))
            {
