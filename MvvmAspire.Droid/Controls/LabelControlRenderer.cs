...
[assembly: ExportRenderer(typeof(  MvvmAspire.Controls.Label), typeof(LabelControlRenderer))]
namespace   MvvmAspire.Controls
{
    public class LabelControlRenderer : LabelRenderer
    {
        ...
        protected   MvvmAspire.Controls.Label Base { get { return (  MvvmAspire.Controls.Label)Element; } }
        ...
        void IsSelectable()
        {
            Control.SetTextIsSelectable(Base.IsSelectable);
        }
