...
[assembly: ExportRenderer(typeof(  MvvmAspire.Controls.HorizontalScrollView), typeof(HorizontalScrollRenderer))]
namespace   MvvmAspire.Controls
{
    public class HorizontalScrollRenderer : Xamarin.Forms.Platform.Android.ScrollViewRenderer
    {
        ...
        public HorizontalScrollRenderer(Context context) : base(context)
        {
        }
