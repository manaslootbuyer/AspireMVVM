...
[assembly: ExportRenderer(typeof(  MvvmAspire.Controls.RoundedComboBox), typeof(RoundedComboBoxRenderer))]
namespace   MvvmAspire.Controls
{
    ...
    public class RoundedComboBoxRenderer : ViewRenderer<RoundedComboBox, GridLayout>, IDialogInterfaceOnClickListener
    {
        ...
        public RoundedComboBoxRenderer(Context context) : base(context)
        {
        }
