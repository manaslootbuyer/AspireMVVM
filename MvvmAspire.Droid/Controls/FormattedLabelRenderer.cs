...
[assembly: ExportRenderer(typeof(  MvvmAspire.Controls.FormattedLabelChild), typeof(FormattedLabelRenderer))]
namespace   MvvmAspire.Controls
{
    public class FormattedLabelRenderer : LabelRenderer
    {
        protected   MvvmAspire.Controls.FormattedLabelChild Base { get { return (  MvvmAspire.Controls.FormattedLabelChild)Element; } }

        public FormattedLabelRenderer(Context context) : base(context)
        {
        }
        ...
        protected override void OnElementChanged(ElementChangedEventArgs<Xamarin.Forms.Label> e)
        {
            ...
            var labelControl = (  MvvmAspire.Controls.FormattedLabelChild)Element;
            ...
            labelControl.PropertyChanged += (s, ev) =>
            {
                switch (ev.PropertyName)
                {
                    ...
                    case "Font": SetTypeface((  MvvmAspire.Controls.FormattedLabelChild)s); break;
                    case "Text": SetTypeface((  MvvmAspire.Controls.FormattedLabelChild)s); break;
                }
            };
        ...
        void SetTextAlignment(  MvvmAspire.Controls.Label element)
        {
