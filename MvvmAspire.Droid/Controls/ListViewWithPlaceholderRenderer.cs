...
//[assembly: ExportRenderer(typeof(  MvvmAspire.Controls.ListView), typeof(  MvvmAspire.Controls.ListViewWithPlaceholderRenderer))]
namespace   MvvmAspire.Controls
{
    public class ListViewWithPlaceholderRenderer : Xamarin.Forms.Platform.Android.ListViewRenderer, AbsListView.IOnScrollListener
    {
        ...
        public ListViewWithPlaceholderRenderer(Context context) : base(context)
        {
            _activity = this.Context as Activity;
        }
    
        protected ListView BaseControl { get { return ((  MvvmAspire.Controls.ListView)this.Element); } }
