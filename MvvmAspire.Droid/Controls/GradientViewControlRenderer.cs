...
[assembly: ExportRenderer(typeof(  MvvmAspire.Controls.GradientView), typeof(  MvvmAspire.Controls.GradientViewControlRenderer))]
namespace   MvvmAspire.Controls
{
    public class GradientViewControlRenderer : ImageRenderer
    {
        protected   MvvmAspire.Controls.GradientView BaseControl { get { return ((  MvvmAspire.Controls.GradientView)this.Element); } }


        public GradientViewControlRenderer(Context context) : base(context)
        {
        }
