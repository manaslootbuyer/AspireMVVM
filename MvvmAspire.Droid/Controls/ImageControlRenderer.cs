...
{
    public class ImageControlRenderer : ViewRenderer<  MvvmAspire.Controls.Image, ImageView>
    {
        protected   MvvmAspire.Controls.Image BaseControl { get { return ((  MvvmAspire.Controls.Image)this.Element); } }
        ...
        public ImageControlRenderer(Context context) : base(context)
        {
        }
        ...
        void SetImageLoader()
        {
            if (BaseControl.ShowActivityIndicatorWhileLoading)
            {
                if (BaseControl.LoaderType ==   MvvmAspire.ImageLoaderType.ProgressRing)
                {
        ...
        private class CustomImageView : ImageView
        {
            ...
            private   MvvmAspire.Controls.Image Element;
            ...
            public void SetElement(  MvvmAspire.Controls.Image Element)
            {
	...
	{
		  MvvmAspire.Controls.Image element;

		public MyTouchListener (  MvvmAspire.Controls.Image element)
		{
			this.element = element;
		}
		...
		public bool OnTouch (Android.Views.View v, MotionEvent e)
		{
			...
			case MotionEventActions.Up:
				this.element.OnTouchEvent (new   MvvmAspire.Controls.TouchEventArgs ((double)e.GetX (), (double)e.GetY (), TouchState.ENDED));
				break;
			case MotionEventActions.Down:
				this.element.OnTouchEvent (new   MvvmAspire.Controls.TouchEventArgs ((double)e.GetX (), (double)e.GetY (), TouchState.BEGAN));
				break;
			case MotionEventActions.Move:
				this.element.OnTouchEvent (new   MvvmAspire.Controls.TouchEventArgs ((double)e.GetX (), (double)e.GetY (), TouchState.MOVED));
				break;
			}
			return true;
		}
