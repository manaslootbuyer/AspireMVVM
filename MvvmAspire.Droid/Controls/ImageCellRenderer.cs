...
[assembly: ExportRenderer(typeof(  MvvmAspire.Controls.ImageCell), typeof(  MvvmAspire.Controls.ImageCellRenderer))]
namespace   MvvmAspire.Controls
{
    public class ImageCellRenderer : Xamarin.Forms.Platform.Android.ImageCellRenderer
    {
        ...
        protected   MvvmAspire.Controls.ImageCell Base { get { return (  MvvmAspire.Controls.ImageCell)base.Cell; } }
        ...
        private Android.Graphics.Rect GetTargetRect(int sourceHeight, int sourceWidth)
        {
            ...
            height = sourceHeight; //BaseUIHelper.ConvertDPToPixels(new PointSize(40));
            width = sourceWidth; //BaseUIHelper.ConvertDPToPixels(new PointSize(40));
